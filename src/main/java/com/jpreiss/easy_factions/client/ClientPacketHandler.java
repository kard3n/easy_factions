...
public class ClientPacketHandler {
    ...
    /**
     * Handles adding chunks to the client-side cache and updates JourneyMap.
     */
    public static void handleClaimChunk(PacketChunkClaim msg) {
        ClientClaimCache.addClaims(msg.chunks());
        for (net.minecraft.resources.ResourceLocation dimLoc : msg.chunks().keySet()) {
            com.jpreiss.easy_factions.client.integration.JourneyMapCompat.rebuildDimension(
    ...
    public static void handleUnclaimChunk(PacketChunkUnclaim msg) {
        ClientClaimCache.removeClaims(msg.chunks());
        for (net.minecraft.resources.ResourceLocation dimLoc : msg.chunks().keySet()) {
            com.jpreiss.easy_factions.client.integration.JourneyMapCompat.rebuildDimension(
                net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.DIMENSION, dimLoc)
            );
